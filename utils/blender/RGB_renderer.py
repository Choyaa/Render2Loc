...
for name in list(poses.keys()):
    ...
    print("euler:", [rot_eulr[0] * 180 / np.pi, rot_eulr[1] * 180 / np.pi,rot_eulr[2] * 180 / np.pi], t)
    print("intrisics: ", w, h, f_x, f_y)
    ...
    if f_mm > 0:
        ...
        focal_mm = 35  # Default focal length in millimeters
        intrin_factor_fx = f_x / focal_mm
        intrin_factor_fy = f_y / focal_mm
        camera_obj = add_camera(
            xyz=t,
            rot_vec_degree=rot_eulr,
            f=focal_mm,

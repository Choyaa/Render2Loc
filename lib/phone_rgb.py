...
#################initial camera
    ...
    camera_obj = add_camera(xyz = t, rot_vec_degree = rot_eulr, f=f_mm, sensor_fit = 'VERTICAL', sensor_width=w/intrin_factor, sensor_height=h/intrin_factor, clip_end=10000)
